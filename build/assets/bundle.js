...
if (sections) {
  ...
  const calculateLinePos = (parentNode, nodeWidth, offset) => {
    ...
    lines.forEach((line, i) => {
      i === 0 ? line.style.left = offset : i === 1 ? line.style.left = `${nodeWidth / (_LINES_COUNT - 1)}px` : i === 2 ? line.style.right = `${nodeWidth / (_LINES_COUNT - 1)}px` : i === 3 ? line.style.right = offset : null;
    });
  };
...
if (btn) {
  ...
  let media = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.matchMedia();
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger);
const items = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray('.service-content__list-item');
if (items.length) {
  items.forEach(item => {
  ...
  function batch(targets, vars) {
    let varsCopy = {},
      ...
      proxyCallback = (type, callback) => {
        let batch = [],
          delay = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.delayedCall(interval, () => {
            callback(batch);
            batch.length = 0;
          }).pause();
        return self => {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.utils.toArray(targets).forEach(target => {
      let config = {};
      for (p in varsCopy) {
        config[p] = varsCopy[p];
      }
...
let matchMedia = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].matchMedia();
...
if (nav) {
  ...
  const submenuBtns = nav.querySelectorAll(".main-nav__list-item > .main-nav__next-btn");
...
const cardTogglers = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".service-card__header-more-btn");
if (cardTogglers) {
  let btns = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.toArray(".service-card__header-more-btn");
...
const serviceCardPreviewTextBlocks = document.querySelectorAll(".service-card__preview-text");
if (serviceCardPreviewTextBlocks.length) {
  init(serviceCardPreviewTextBlocks);
}
const serviceCardStuffBlocks = document.querySelectorAll(".service-card__section--stuff");
...
const scrollableSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".scrollable-slider", {
  slidesPerView: "auto",
  loop: true,
  spaceBetween: 15,
  speed: 1000,
